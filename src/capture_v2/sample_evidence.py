...
def build_capture_v2_sample_data() -> dict[str, Any]:
    ...
    data: dict[str, Any] = {
        ...
        "status_line": "Sample mode ・ Local only ・ Estimated until calibrated ・ Expert review required",
        "analysis_mode": "sample",
        "evidence_source": "sample",
        "analysis_mode_label": "Sample mode",
        "analysis_source_label": "sample",
        "analysis_status": "sample",
        "analysis_message": "Sample evidence is loaded. Upload a local video to run OpenCV or MediaPipe analysis.",
        "warnings": [],
        "analysis_summary": {
            "sampled_frame_count": len(timeline),
            "frame_count": len(timeline),
            "sample_interval_sec": "sample mode",
            "max_sampled_frames": len(timeline),
            "focused_window_sec": "sample mode",
        ...
        "sample_video": {
            ...
            "note": "Sample mode does not infer real angles. It is a UI placeholder only.",
        },
        "evidence_summary": {
            "timestamp": "00:13.2",
            "frame_id": "frame_0396",
            ...
            "movement_speed": "Sample data only",
            "pause_detected": True,
            "confidence": 0.72,
            "status": "Inferred",
        },
        ...
        export_items.append(
            {
                ...
                "detected_signal": deepcopy(item.get("detected_signal") or {}),
